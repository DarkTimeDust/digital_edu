...
print(df_train[['occupation_type','occupation_name','career_start','career_end']].tail(20))
...
df_train.langs = df_train.langs.apply(set_langs)
...
print(df_train[columns_names].head(50))
...
df_test.langs = df_test.langs.apply(set_langs)
